...
from fubot.config.schema import EmailConfig
...
class EmailChannel(BaseChannel):
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        base_subject = self._last_subject_by_chat.get(to_addr, "fubot reply")
    ...
    def _fetch_messages(
        ...
        try:
            ...
            try:
                ...
                logger.debug("IMAP logout failed; connection already closed")
    ...
    def _reply_subject(self, base_subject: str) -> str:
        subject = (base_subject or "").strip() or "fubot reply"
