...
from fubot.config.schema import MochatConfig
    ...
    async def stop(self) -> None:
        ...
        if self._socket:
            try:
                ...
                logger.debug("Mochat socket disconnect failed during shutdown")
            self._socket = None
    ...
    async def _start_socket_client(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.debug("Mochat websocket cleanup failed after connect error")
            self._socket = None
            return False
