...
from fubot.config.paths import get_media_dir
from fubot.config.schema import TelegramConfig
from fubot.utils.helpers import split_message
...
class TelegramChannel(BaseChannel):
    ...
    async def _send_with_streaming(
        ...
        try:
            ...
            logger.debug("Telegram draft streaming unavailable; sending final message only")
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm fubot.\n\n"
