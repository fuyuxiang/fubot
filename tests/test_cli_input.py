...
from fubot.cli import commands
...
def mock_prompt_session():
    ...
    with patch("fubot.cli.commands._PROMPT_SESSION", mock_session), \
         patch("fubot.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("fubot.cli.commands.PromptSession") as MockSession, \
         patch("fubot.cli.commands.FileHistory") as MockHistory, \
