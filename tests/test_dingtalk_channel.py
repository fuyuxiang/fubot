...
import fubot.channels.dingtalk as dingtalk_module
from fubot.channels.dingtalk import DingTalkChannel, FubotDingTalkHandler
...
async def test_handler_uses_voice_recognition_text_when_text_is_empty(monkeypatch) -> None:
    ...
    handler = FubotDingTalkHandler(channel)
